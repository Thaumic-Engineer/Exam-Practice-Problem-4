/**
 * File: JavaFx/src/examprac04/MileageCalculatorNoConversion.java
 * Package: examprac04
 * @author Christopher Williams
 * Edited by:Noah Shook
 * Created on: Apr 12, 2017
 * Last Modified: Apr 18, 2022
 * Description:  Modify the code to allow for the two radioButtons to be replaced with a combobox and update the event handling to work with the comboBox
 */
package examprac04;
...
public class MileageCalculatorNoConversion extends Application {
    ...
    public void start(Stage primaryStage) {   	
        ...
        cbMPGKPL.setOnAction(e -> changeLabels());
    ...
    private void changeLabels() {
    	...
    	if (cbMPGKPL.getValue().equals("L/100KM")  && lblCapacity.getText().equals(defaultCapacity)) {
        	// update labels
    ...
    private void calcMileage() {       
        ...
        double result = 0.0;
        if (cbMPGKPL.getValue().equals("L/100KM")) {
        	// liters / 100KM
